...
void registerIdealEnvIST( std::string fileName4, int version, pd::Matrix4<float> M, float density,   std::string fileName3,int PL_A1){

        const char * fileName = fileName4.c_str();
        const char * fileName2 = fileName3.c_str();
        print("[registerIdealEnvIST] Register All Leaves");
        std::cout << "Your filename 1  =  " << fileName << std::endl;
        std::cout << "Your filename 2  =  " << fileName2 << std::endl;
        print("[registerIdealEnvIST] Register All Leaves");
        numOfFile = PL_A1;
        ...
        while(maxNum>start)
        {
            ...
            test::registerIdealEnvIST(L3,1,M,1,F3,PL_A1);
...
std::string num = std::to_string(numOfFile);
std::cout << "Your countFile   =  " << num << std::endl;
 std::string countFile = "ToothTest"+num+".obj";
    std::cout << "Your countFile   =  " <<countFile << std::endl;
        std::ofstream out(countFile);
        out<< "# ";
	...
	std::string num = std::to_string(numOfFile);
	std::cout << "Your countFile   =  " << num << std::endl;
 	std::string countFile = "ToothFrame"+num+".obj"; 
	std::string countFileDae = "ToothFrame"+num+".dae"; 
	//std::string filePath = "tooth.obj";
	std::string filePath = countFile;
        std::ifstream in(filePath);
        std::string line;
        std::ofstream out(countFileDae);
        int count = 0;
